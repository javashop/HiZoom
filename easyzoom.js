(function ($) {
    ...
    var notTouchBorder = function () {
        if (leftDistance >= config.width / 4 && leftDistance <= 3 * config.width / 4 && topDistance >= config.width / 4 && topDistance <= 3 * config.width / 4) {
            return true;
        }
        return false;
    };
    ...
    var enterLogic = function ($this, event) {
        ...
        if (leftDistance <= config.width / 4 && topDistance <= config.width / 4) {
            ...
            // 左下
        } else if (leftDistance <= config.width / 4 && topDistance >= 3 * config.width / 4) {
            magnifier.css({
            ...
            // 右上
        } else if (leftDistance >= 3 * config.width / 4 && topDistance <= config.width / 4) {
            magnifier.css({
                top: 0,
            ...
            // 右下
        } else if (leftDistance >= 3 * config.width / 4 && topDistance >= 3 * config.width / 4) {
            magnifier.css({
                top: config.width / 2 + 'px',
                left: config.width / 2 + 'px'
            });
    ...
    var mainLogic = function () {
        ...
        if (notTouchBorder(leftDistance, topDistance)) {
            ...
            // 如果竖直方向上碰到了边缘
            if (leftDistance - config.width / 4 >= 0 && leftDistance - 3 * config.width / 4 <= 0) {
                magnifier.css({
                    left: leftDistance - config.width / 4 + 'px'
                });
                bigImageDOM.css({
            ...
            // 如果水平方向上碰到了边缘
            if (topDistance - config.width / 4 >= 0 && topDistance - 3 * config.width / 4 <= 0) {
                magnifier.css({
                    top: topDistance - config.width / 4 + 'px'
                });
                bigImageDOM.css({
